...
datafile = '20230906_CV_TJ trial-300mM-3.txt'       # Output file for time, curr, volt data


test_name = 'cyclic'        # The name of the test to run
curr_range = '1000uA'        # The name of the current range [-100uA, +100uA]
sample_rate = 300.0         # The number of samples/second to collect

volt_min = -0.5             # The minimum voltage in the waveform (V)
volt_max =  0.8             # The maximum voltage in the waveform (V)
#volt_per_sec = 0.050        # The rate at which to transition from volt_min to volt_max (V/s)
volt_per_sec = 0.500         # The rate at which to transition from volt_min to volt_max (V/s)
num_cycles = 5              # The number of cycle in the waveform
